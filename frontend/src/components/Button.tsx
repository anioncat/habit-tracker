...
const Button = ({
  ...
  const colors =
    (secondary ? AppStyle.secondaryBg : AppStyle.primaryBg) +
    ' [&_svg]:stroke-base ' +
    AppStyle.whiteText
  ...
  const disabled = `disabled:filter-none ${AppStyle.disabledButtonBg} disabled:opacity-80 disabled:cursor-default`
